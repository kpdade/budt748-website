...
```
index.html      Homepage (hero section and feature grid)
about.html      About page (course details)
contact.html    Contact page (contact details and a Bootstrap form)
css/
  styles.css    Shared styles and homepage hero
  styles2.css   About page styles
  styles3.css   Contact page styles
images/         Exported assets
```
